...
statuses = tweepy.Cursor(api.search, q=('#EleiçãoSemLulaÉFraude' or '#EleicaoSemLulaEFraude' or '#CadêAProva' or '#CadeAProva'), since='2018-01-24', until='2018-01-26').items()
row=[]
    #----------------------------------------------------------------#
