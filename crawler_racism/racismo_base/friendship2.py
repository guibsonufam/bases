...
userID_target = '774820925493637120'
api=tweepy.API(auth, wait_on_rate_limit=True)

row_segue=[]
row_naoSegue=[]

arq2 = open("lucagliardi/seguem.txt", "w")
arq3 = open("lucagliardi/nao_seguem.txt", "w")
arq4 = open("lucagliardi/error_exception","w")
arq = open('lucagliardi/names.txt', 'r')
texto = arq.readlines()
