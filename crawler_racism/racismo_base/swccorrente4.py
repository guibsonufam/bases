...
arq = csv.writer(open("eleicao", "w"), delimiter='\t',quotechar='"')
count = 0
arq2 = open("eleicao.txt", "w")
statuses = tweepy.Cursor(api.search, q=('RT' and '#EleiçãoSemLulaÉFraude'), since='2018-01-22', until='2018-01-23').items()
row=[]
    #----------------------------------------------------------------#
